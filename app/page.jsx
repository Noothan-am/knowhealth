...
import { FileText, LayoutDashboard, CreditCard, User } from "lucide-react";
    ...
    <div className="relative bg-[#f2fbff]">
            ...
            {[
              {
                ...
                subheading: "Qualified Professionals",
                color: "#FF6B6B",
              },
              {
                icon: Clock,
                title: "24/7 Support",
                subheading: "Available at All Times",
                color: "#4ECDC4",
              },
              {
                icon: PiggyBank,
                title: "Affordable Care",
                subheading: "Budget-Friendly",
                color: "#45B7D1",
              },
              {
                icon: Shield,
                title: "Privacy & Support",
                subheading: "Confidential Service",
                color: "#FFA07A",
              },
            ].map((item, index) => (
              <div
                key={index}
                className="flex items-center space-x-4 w-1/4 min-w-[250px] sm:w-1/4"
              >
                <item.icon
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end">
          <div className="w-full sm:w-3/4 md:w-2/3 lg:w-1/2">
            <div className="flex items-center mb-1 sm:mb-2">
              ...
              <Link
                href="#"
                className="text-[#2e6da5] hover:text-[#1d4999] text-xs sm:text-sm md:text-base font-semibold inline-block leading-relaxed"
              >
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#2e6da5] mb-4 sm:mb-6 md:mb-8 leading-relaxed">
              We provide a wide range of medical services to ensure your health
              and well-being.
            </p>
            ...
            <div className="bg-[#012b6d] rounded-lg shadow-xl p-6 md:p-8 mb-12">
                ...
                {[
                  {
                    ...
                    description: "Expert care for your good health",
                    link: "/coming-soon",
                  },
                  {
                    icon: FaMicroscope,
                    ...
                    description:
                      "Advanced diagnostic testing with affordability",
                    link: "/diagnostics",
                  },
                  {
                    icon: Scissors,
                    ...
                    description:
                      "Affordable Surgery Support at your fingertips",
                    link: "/prescription",
                  },
                  {
                    icon: LayoutDashboard,
                    title: "Dashboard",
                    description: "Full-service Medication management",
                    link: "/patient-dashboard",
                  },
                ].map((item, index) => (
                  <div
                    key={index}
                    className="flex items-start space-x-4 bubble-hover"
                  >
              ...
              <div className="flex justify-center">
                <Link href="/coming-soon">
                  {" "}
                  {/* Replace '/coming-soon' with your desired link */}
                  <Button
                    variant="default"
                    size="lg"
      ...
      <div className="bg-[#2e6da5] py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-[#012b6d] mb-12 text-center">
            Collaborating with the best in medical diagnostics
          </p>
            ...
            {[
              {
                ...
                description: "Cutting-edge diagnostic solutions",
              },
              {
                name: "BioCore Analytics",
                description: "Precision in molecular testing",
              },
              {
                name: "Vitality Diagnostics",
                description: "Comprehensive health screenings",
              },
              {
                name: "GenomeWise",
                description: "Advanced genetic testing services",
              },
            ].map((lab, index) => (
              <div
                key={index}
                className="bg-[#012b6d] shadow-lg overflow-hidden"
              >
                <Image
                  src={`/placeholder.svg?height=150&width=300&text=Lab+Image+${
                    index + 1
                  }`}
                  alt={`${lab.name} image`}
                  width={300}
